# -*- coding: utf-8 -*-
#
# mingwpy documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'mingwpy.tex', u'mingwpy Documentation',
   u'Carl Kleffner and collaborators', 'manual'),
]
...
man_pages = [
    (master_doc, 'mingwpy', u'mingwpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'mingwpy', u'mingwpy Documentation',
   author, 'mingwpy', 'One line description of project.',
   'Miscellaneous'),
]
